...
\fb{
This has been taken from \cite{FangPuthenpura93}.
}
\end{theorem}
...
\fb{
This is discussed in Chvatal \cite[ch.4]{lp:Chvatal}.
}
...
\fb{
Discussion on the complexity of linear programming.
}
...
In 1979 Khachiyan shows how to adapt the ellipsoid method for convex
...
consequence of that \cite{Bixby02}. Also \cite{Bixby94}, but that mainly
concentrates on Cplex...
}
...
\fb{
Add a citation for the hyper-sparse case.
}
...
Karmarkar \cite{Karmarkar} notes:
\begin{quote}
...
\fb{
Maybe cite Margaret Wright \cite{MWright92}.
}
