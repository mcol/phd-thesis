...
$\alpha^{\hat\omega}_P\alpha^{\hat\omega}_D=0.583$, 
...
product $\alpha^{\hat\omega}_P\alpha^{\hat\omega}_D$ of about 0.375.
%
\begin{figure}[ht]
\centering
...
In Figure~\ref{fig:PerfProfileBN}, we show the CPU-time based 
