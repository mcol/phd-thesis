...
to the predictor direction alone.

Undoubtedly such an occurrence has a dramatic impact on the 
efficiency of the solver, as a lot of CPU time has been consumed
fruitlessly trying to find some correction to the predictor
direction.
If the step from this point is too short, the new iterate may
...
system when $t = t^* = X\Delta s^* + S\Delta x^*$. Therefore,
the $t^*$ proves to be the best overall,
