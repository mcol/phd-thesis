...
They concern the choice of the starting point, the computation
...
of redundant constraints. He we mention the fact that presolve
...
operations: 
\begin{description}
\item[Factorisation:] computation of the Cholesky factors of a sparse 
symmetric matrix; 
...
with respect to the direction $\Delta w$ of (\ref{eq:CompositeDirection}).
