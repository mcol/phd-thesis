...
columns, fixed variables, removing redundant constraints 
...
equations.
We remark, however, that a wealth of research explored the use
...
larger than that of backsolving: in general this procedure
...
thus considering the right-hand as
\[
 \left[ 
  \begin{array}{c}
...
Assume that a predictor direction $\Delta_p w$ is given and the corresponding
      ...
      \REQUIRE An iterate $w^k$, a search direction $\Delta_p w$,
        ...
        \REPEAT
           \STATE Solve system (\ref{eq:NewtonSystem}) with right-hand side
                  $r_m$, $t$ (\ref{eq:MCCRhs}), for a centrality
