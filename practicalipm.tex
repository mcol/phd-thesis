...
\cite{Bixby02}). 
The main reason for this is that the solution of a problem,
being a vertex, is an ideal starting point for a perturbed instance.
...
\caption{Typical behaviour of an interior point method if warmstarted
