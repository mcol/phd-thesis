...
%
\be \label{eq:SP}
  \min_x \E_\xi(f(x, \xi)) \quad \text{ s.t. }\; g(x, \xi) \le 0,
\ee
%
...
\be  \label{eq:RedTreeDualContribution}
  {W^{r(l_t)}}^T \hat y^{l_t}+\sum_{i\in\mathcal{D}_{l_t}}{T^{r(i)}}^T \hat y^i
...
%   & \le \|h^{l_t} \! - \! h^{r(l_t)}\| +
%         \|T^{l_t} \! - \! T^{r(l_t)}\| \| x^{a(r(l_t))}_R \|
%         + \|W^{l_t} - W^{r(l_t)}\| \| x^{r(l_t)}_R\| \\
...
% & = p^{l_t}(q^{l_t} \!-\! q^{r(l_t)})
%     - \frac{p^{l_t}}{p^{r(l_t)}_R}(W^{l_t} \!-\! W^{r(l_t)})^T y^{r(l_t)}_R
%     -\sum_{i \in \mathcal{D}_{l_t}} (T^{i} \!-\! T^{r(i)})^T 
%           \frac{p^i}{p^{r(i)}_R} y^{r(i)}_R \\
 & = p^{l_t}(q^{l_t} \!-\! q^{r(l_t)})
     - \frac{p^{l_t}}{p^{r(l_t)}_R} \Big[
       (W^{l_t} \!-\! W^{r(l_t)})^T y^{r(l_t)}_R
       +\sum_{i\in \mathcal{D}_{l_t}} %\setminus\mathcal{D}_{r(l_t)}^R}
           (T^{i} \!-\! T^{r(i)})^T 
...
%for $i \in \mathcal{D}_{l_t}\cap\mathcal{D}_{r(l_t)}^R$.
%
