...
\fb{
Introduce barrier problems and theorems as done in Megiddo \cite{Megiddo}
and Guler Roos Terlaky Vial \cite{GulerRoosTerlakyVial}.
}
...
At each iteration $\mu$ is monotonically decreased by a quantity
...
\fb{
See also Nick Gould's slides at cerfacs, and
a chapter in Ye's book.
