...
%Mar:  8,  9, 13, 15, 16, 17, 19, 20, 21, 22, 27, 28, 29, 30
...
consequences by Deza et~al. \cite{DezaNematollahiPeyghamiTerlaky},
...
Given a starting iterate $w^0 = (x^0,y^0,s^0)$, the value $\mu^0$ 
...
The ratio $\varrho(XSe)$ is a measure between 0 and 1, and is 1
